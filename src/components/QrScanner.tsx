  ...
  const handleQRScan = async (qrData: string) => {
    ...
    try {
      ...
      const result = await scanTicket({ 
        uniqueId: qrData, 
        timestamp: Date.now(),
        scannedBy: scannerName || undefined
      });
  ...
  return (
    <div className="h-full w-full relative bg-black overflow-hidden">
      ...
      {showModal && modalData && (() => {
        ...
        return (
        <div className="absolute inset-0 bg-black/80 flex items-end sm:items-center justify-center z-50 p-0 sm:p-4">
          <div className="bg-white rounded-t-2xl sm:rounded-xl max-w-sm w-full overflow-hidden shadow-2xl max-h-[85vh] sm:max-h-[90vh] overflow-y-auto">
            {/* Modal Header */}
            <div className={`p-4 sm:p-6 text-center ${
              ...
              <p className="text-sm sm:text-base text-white/90">{modalData.message}</p>
            </div>
                ...
                <>
                  ...
                  <div className="bg-gray-50 rounded-lg p-3 sm:p-4 space-y-2 sm:space-y-3">
                    <div className="text-center">
                      ...
                      {modalData.ticket.teamMemberCount && (
                        <p className="text-xs sm:text-sm text-gray-600">
                    ...
                    {/* Room and Slot Info */}
                    {(modalData.ticket.roomNumber || modalData.ticket.slotNumber) && (
                      <div className="border-t pt-2 sm:pt-3">
                        <div className="flex justify-center gap-3 sm:gap-4">
                          {modalData.ticket.roomNumber && (
                          ...
                          {modalData.ticket.slotNumber && (
                            <div className="text-center px-3 sm:px-4 py-1.5 sm:py-2 bg-purple-50 rounded-lg">
                              <p className="text-xs text-purple-600 font-medium">Slot</p>
            ...
            <div className="p-4 sm:p-6 pt-0">
              <button
                onClick={closeModal}
                className="w-full bg-blue-600 text-white py-3 sm:py-4 px-4 rounded-xl hover:bg-blue-700 active:bg-blue-800 transition-colors font-medium text-base sm:text-lg"
              >
                Continue Scanning
              </button>
            </div>
