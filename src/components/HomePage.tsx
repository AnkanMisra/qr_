                ...
                <div className="pt-safe-top px-4 py-4">
                    ...
                    <div className="flex bg-gray-100 rounded-xl p-1 gap-1">
                        <button
                            ...
                            className={`flex-1 py-3 px-2 rounded-lg text-sm font-medium transition-all duration-200 ${activeTab === "scan"
                        ...
                        <button
                            ...
                            className={`flex-1 py-3 px-2 rounded-lg text-sm font-medium transition-all duration-200 ${activeTab === "list"
                                ? "bg-white text-blue-600 shadow-md scale-105"
                                : "text-gray-600 active:scale-95"
                                }`}
                        >
