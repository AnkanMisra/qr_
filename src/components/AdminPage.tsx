...
export function AdminPage() {
  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    // Execute async operation without returning a promise
    void (async () => {
      try {
  ...
  const handleLogout = () => {
    if (sessionToken) {
      // Execute async operation without returning the promise
      void (async () => {
        try {
                ...
                <div className="flex items-start space-x-3">
                  ...
                  >
                    <path
                      ...
                      strokeLinejoin="round"
                      strokeWidth={2}
                      d="M9 12l2 2 4-4m5.586-4.414A2 2 0 0019 5.586L16.414 3A2 2 0 0015 2H9a2 2 0 00-1.414.586L4.586 6A2 2 0 004 7.414V16a2 2 0 001.414 1.414L9 21a2 2 0 001.414 0l3.586-3.586A2 2 0 0015 16V7.414a2 2 0 00-1.414-1.414z"
                    />
                  </svg>
                  <div>
                    ...
                    <p className="text-sm text-green-700 mt-1">
                      Server-side validation with encrypted sessions and
      ...
      <header className="sticky top-0 z-10 bg-white border-b">
        <div className="px-4">
          <div className="max-w-5xl mx-auto py-3">
            ...
            {/* Auth status */}
            <div className="bg-green-50 border border-green-200 rounded-lg p-3 mb-4 max-w-xl mx-auto">
              ...
              <p className="text-xs text-green-700 mt-1 text-center">
                Server-side validated with automatic expiration
              </p>
            </div>
